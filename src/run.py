...
parser.add_argument(
    "--imagenet_pretrain",
    help="if use ImageNet pretrained audio spectrogram transformer model",
...
parser.add_argument(
    "--dataset_std", type=float, default=4.5689974, help="the dataset spectrogram std"
)
parser.add_argument(
    "--audio_length", type=int, default=1024, help="the dataset spectrogram std"
)
parser.add_argument(
    "--noise", help="if augment noise", type=ast.literal_eval, default="False"
)
...
parser.add_argument(
    "--loss", type=str, default=None, help="loss function", choices=["BCE", "CE"]
)
parser.add_argument(
    "--warmup",
    help="if warmup the learning rate",
    type=ast.literal_eval,
    default="False",
)
parser.add_argument(
...
parser.add_argument(
    "--wa", help="if weight averaging", type=ast.literal_eval, default="False"
)
parser.add_argument(
    "--wa_start",
    type=int,
...
if args.dataset == "speechcommands":
    ...
    np.savetxt(
        args.exp_dir + "/eval_result.csv", [val_acc, val_mAUC, eval_acc, eval_mAUC]
    )
